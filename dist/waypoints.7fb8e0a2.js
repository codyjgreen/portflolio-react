...
(function ($, k, m, i, d) {
  var e = $(i),
    ...
    if (!o) {
      return -1;
    }var n = o.waypoints.length - 1;while (n >= 0 && o.waypoints[n].element[0] !== p[0]) {
      n -= 1;
    }return n;
  },
      f = [],
    ...
    var o = null;$.each(f, function (p, q) {
      ...
      c = { init: function init(o, n) {
      this.each(function () {
        var u = $.fn[k].defaults.context,
            q,
            t = $(this);if (n && n.context) {
          u = n.context;
        }if (!$.isWindow(u)) {
          u = t.closest(u)[0];
        }q = j(u);if (!q) {
          q = new l(u);f.push(q);
            ...
            r = $.extend({}, s, n);r.offset = r.offset === "bottom-in-view" ? function () {
      ...
      $.each(f, function (r, s) {
        var q = $.isWindow(s.element[0]),
            ...
            o = q ? 0 : s.element.scrollTop();$.each(s.waypoints, function (u, x) {
          if (!x) {
            return;
          }var t = x.options.offset,
              w = x.offset;if (typeof x.options.offset === "function") {
